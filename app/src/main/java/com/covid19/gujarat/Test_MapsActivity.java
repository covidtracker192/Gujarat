...
public class Test_MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Test Center 1
        final LatLng center1 = new LatLng(22.305329, 70.798452);
        mMap.addMarker(new MarkerOptions().position(center1).title("Pandit Dindayal Upadhyay Medical College").snippet("website: http://pdumcrajkot.org/"));
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                if(marker.getPosition().equals(center1)) {
                    Uri uriUrl = Uri.parse("http://pdumcrajkot.org/");
